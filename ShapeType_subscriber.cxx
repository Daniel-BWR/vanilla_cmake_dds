...
int process_data(dds::sub::DataReader<VideoStream>& reader)
{
    // Take all samples
    int count = 0;
    dds::sub::LoanedSamples<VideoStream> samples = reader.take();
...
int subscriber_main(int domain_id, int sample_count)
{
    ...
    dds::topic::Topic<VideoStream> topic(participant, "Example ShapeTypeExtended");

    // Create a DataReader with default Qos (Subscriber created in-line)
    dds::sub::DataReader<VideoStream> reader(dds::sub::Subscriber(participant), topic);
